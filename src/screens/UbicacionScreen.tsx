      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(0).springify()} style={styles.mapContainer}>
          <GlassCard elevation={2} style={styles.mapCard}>
            <View style={[styles.mapPlaceholder, { backgroundColor: palette.darkBlue }]}>
              <Ionicons name="map" size={48} color="rgba(255,255,255,0.3)" />
              <TouchableOpacity style={styles.mapButton} activeOpacity={0.8} onPress={openMaps}>
        ...
        <Animated.View entering={FadeInDown.delay(150).springify()}>
          <GlassCard elevation={2} style={styles.infoCard}>
            <View style={[styles.iconCircle, { backgroundColor: `${palette.darkBlue}15` }]}>
              <Ionicons name="location" size={24} color={palette.darkBlue} />
            </View>
          ...
          <TouchableOpacity activeOpacity={0.7} onPress={callPhone}>
            <GlassCard elevation={2} style={styles.infoCard}>
              <View style={[styles.iconCircle, { backgroundColor: `${palette.gold}15` }]}>
                <Ionicons name="call" size={24} color={palette.gold} />
              </View>
              <View style={styles.infoContent}>
        ...
        <Animated.View entering={FadeInDown.delay(350).springify()} style={styles.quickInfo}>
          <GlassCard elevation={1} style={styles.quickInfoCard}>
            <Ionicons name="car-outline" size={20} color={palette.darkBlue} />
          ...
          <GlassCard elevation={1} style={styles.quickInfoCard}>
            <Ionicons name="wifi-outline" size={20} color={palette.darkBlue} />
          ...
          <GlassCard elevation={1} style={styles.quickInfoCard}>
            <Ionicons name="restaurant-outline" size={20} color={palette.darkBlue} />
